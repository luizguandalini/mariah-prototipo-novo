  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <h2 className="text-3xl font-bold text-gray-900">Créditos & Planos</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Comprar Créditos Avulsos</h3>
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={pacote.qtd} className="border-2 border-gray-200 rounded-lg p-4">
                {pacote.economia > 0 && (
                  <span className="text-xs font-bold text-primary mb-2 block">
                    ECONOMIA DE {pacote.economia}%
                  </span>
                )}
                <p className="text-3xl font-bold text-gray-900">{pacote.qtd}</p>
                <p className="text-sm text-gray-600 mb-4">créditos</p>
